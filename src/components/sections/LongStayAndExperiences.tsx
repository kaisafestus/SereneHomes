...
const EXPERIENCES = [
  {
    ...
    desc: "Explore the futuristic city under development.",
  },
  {
    name: "Karura Forest",
    icon: <TreePine className="text-accent" />,
    desc: "Cycling and hiking in Nairobi's green lung.",
  },
  {
    name: "Two Rivers Mall",
    icon: <ShoppingCart className="text-accent" />,
    desc: "Kenya's premier shopping and entertainment destination.",
  },
  {
    name: "Kamakis Dining",
    icon: <Coffee className="text-accent" />,
    desc: "The famous Eastern Bypass 'nyama choma' experience.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Whether you're relocating, on a corporate assignment, or just
                need a long-term sanctuary, our monthly and weekly packages
                ...
                <Card className="border-primary/20 bg-primary/5">
                  <CardContent className="p-8">
                    ...
                    <ul className="space-y-3 text-sm text-primary/70 mb-6">
                      <li className="flex items-center space-x-2">
                        <CheckCircle2 size={16} />{" "}
                        <span>Perfect for business</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle2 size={16} /> <span>High-speed WiFi</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <CheckCircle2 size={16} />{" "}
            ...
            <div className="p-8 bg-muted rounded-3xl border">
              ...
              <p className="text-sm text-muted-foreground italic leading-relaxed">
                "Moving to Ruiru or Membley? Our relocation package provides a
                stress-free transition with local orientation and support while
          ...
          <div className="space-y-12">
            <div>
              <h2 className="font-heading text-4xl font-bold text-primary mb-6">
                The Membley Experience
              </h2>
              <p className="text-muted-foreground text-lg leading-relaxed mb-10">
                Membley is one of Nairobi's best-kept secrets—a controlled,
                secure neighborhood that offers a perfect balance of tranquility
                and accessibility.
              </p>
            ...
            <div className="relative rounded-[3rem] overflow-hidden aspect-video shadow-2xl">
              ...
              <div className="absolute bottom-6 left-4 right-4 md:bottom-8 md:left-8 md:right-8">
                ...
                <h4 className="text-white font-heading text-xl md:text-2xl font-bold">
