      ...
      <div className="container relative z-10 px-6 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light">
            Modern executive apartment offering comfort, security, convenience, and seamless access to Nairobi's key destinations.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link 
              ...
              target="_blank"
              className={cn(buttonVariants({ variant: "default" }), "bg-accent hover:bg-accent/90 text-primary font-bold px-8 h-14 rounded-full text-lg min-w-[200px]")}
            >
              Book Your Stay
            </Link>
            <Link 
              href="#showcase"
              className={cn(buttonVariants({ variant: "outline" }), "border-white/30 bg-white/10 text-white hover:bg-white/20 backdrop-blur-md font-bold px-8 h-14 rounded-full text-lg min-w-[200px]")}
            >
              View Apartment
            </Link>
          </div>
