...
export function Reviews() {
  return (
    <section
      id="reviews"
      className="py-24 bg-primary text-white overflow-hidden px-6"
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-8 text-center md:text-left">
          <div className="max-w-2xl">
            ...
            <p className="text-white/60">
              Hear from our community of business travelers, digital nomads, and
              families.
            </p>
          </div>
            ...
            {REVIEWS.map((review, index) => (
              ...
              >
                <div className="h-full bg-white/5 backdrop-blur-sm p-10 rounded-[2.5rem] border border-white/10 relative group hover:bg-white/10 transition-colors duration-500">
                  <Quote className="absolute top-6 right-4 md:top-10 md:right-10 text-accent/20 w-12 h-12" />
                  ...
                  <p className="text-lg leading-relaxed mb-8 italic text-white/80">
                    "{review.text}"
                  </p>
