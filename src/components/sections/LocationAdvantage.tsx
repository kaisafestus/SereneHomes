        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              Why stay stuck in Nairobi traffic? Stay in a peaceful, secure,
              premium apartment with direct access to everything that matters.
              We are strategically positioned along the Eastern Bypass for
              maximum convenience.
            </p>
          ...
          <div className="relative aspect-square lg:aspect-auto lg:h-full min-h-[420px] rounded-[3rem] overflow-hidden shadow-2xl border">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <div className="relative">
                ...
                <div className="relative bg-primary text-white p-4 sm:p-6 rounded-2xl shadow-2xl border-2 border-accent flex flex-col items-center min-w-[160px] sm:min-w-[180px] md:min-w-[200px]">
                  <MapPin className="text-accent mb-2" size={28} />
                  <span className="font-heading font-bold text-center text-sm sm:text-base">
                    SERENE HOMES
                  </span>
                  <span className="text-[9px] sm:text-[10px] uppercase tracking-widest text-accent">
                    Membley, Ruiru
                  </span>
                </div>
              </div>
            ...
            <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 bg-white/90 backdrop-blur p-4 md:p-6 rounded-2xl shadow-xl border">
              ...
              <p className="text-sm text-muted-foreground">
                Located right along the Eastern Bypass in the serene Membley
                Estate. Secure, accessible, and quiet.
              </p>
            </div>
          </div>
        </div>
