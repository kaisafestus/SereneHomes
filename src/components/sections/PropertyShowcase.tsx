...
const ROOMS = [
  {
    ...
    description: "Spacious executive living area with premium furniture and smart TV.",
  },
  {
    id: "bedroom",
    label: "Bedroom",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground">
              Every corner of Serene Homes Membley is designed for comfort, productivity, and luxury.
            </p>
          </div>

          <Tabs defaultValue="living" className="w-full md:w-auto" onValueChange={setActiveTab}>
              ...
              activeTab === room.id && (
                ...
                >
                  ...
                  <div className="absolute bottom-10 left-10 right-10">
                    <h3 className="text-white font-heading text-3xl font-bold mb-2">{room.label}</h3>
